...
@Component({
  selector: 'app-filtro-min-max',
  standalone: true,
  imports: [FormsModule,RouterLink],
  templateUrl: './filtro-min-max.component.html',
  styleUrl: './filtro-min-max.component.css'
})
export class FiltroMinMaxComponent {
  Preciomin = 0
  Preciomax = 500
  busqueda ="";
  juegoEncontrado: any;
  ...
  buscarJuego() {
    this.juegoEncontrado = this.productos.find(juego => juego.id === this.busqueda);
